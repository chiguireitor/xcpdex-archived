    ...
    <div class="row">
        <div class="col-md-8">
                ...
                <div class="col-sm-6">
                    <div class="form-group">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6" id="get_asset">
                ...
                <div class="col-sm-6">
                    <div class="form-group">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6" id="give_asset">
            ...
            <div class="row">
                <div class="col-sm-6">
                    <div class="form-group">
                        <button type="submit" class="btn btn-block btn-lg btn-primary"><small><i class="glyphicon glyphicon-edit"></i></small> Generate Raw Transaction</button>
                    </div>
                </div>
            </div>
